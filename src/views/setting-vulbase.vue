<template>
    <div>
        <Card>
            <Button type="primary" size="large" @click="vulshow(0,true)">
        ...
        <div style="float: left;">共 {{total}} 条</div>
            <div style="float: right;">
                <Page show-elevator :current="current" :total="total" :page-size=30 @on-change="vulsearch"></Page>
            </div>
        </div>
        <Modal
            v-model="modalinfo"
            ...
            <Form :model="rowinfo" :label-width="80">
                <FormItem label="漏洞名称">
                    <Input type="text" v-model="rowinfo.vulname"></Input>
                </FormItem>
                <FormItem label="漏洞等级">
                ...
                <FormItem label="漏洞编号">
                    <Input type="text" v-model="rowinfo.vulno"></Input>
                </FormItem>
                <FormItem label="漏洞详情">
                    <Input type="textarea" v-model="rowinfo.vuldesc"></Input>
                </FormItem> 
                <FormItem label="修复建议">
                    <Input type="textarea" v-model="rowinfo.vulplan"></Input>
                </FormItem>
            </Form>
        </Modal>
    </div>
